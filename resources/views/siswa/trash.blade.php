...
@section('title', 'Tempat Sampah Siswa — Jurnal ESEMKITA')
    ...
    <div class="card">
        <div class="card-top-header">
            <div>
                ...
                <p>Daftar siswa yang dihapus sementara. Anda dapat memulihkan atau menghapus permanen.</p>
            </div>
            <a href="{{ route('siswa.index') }}" class="btn-back-main">
                            ...
                            <td style="text-align:center;">
                                <div style="display:inline-flex; gap:6px;">
                                    <form action="{{ route('siswa.restore', $s->id_siswa) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        <button type="submit" class="btn-act btn-restore" title="Pulihkan Siswa">
