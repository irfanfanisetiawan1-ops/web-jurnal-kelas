...
<head>
    ...
    <title>Tambah Ruangan — Jurnal Kelas</title>
    ...
    <div class="form-card">
        <div class="form-header">
            ...
            <div class="form-title">
                ...
                <p>Isi formulir di bawah ini untuk menambahkan data ruangan ke database</p>
            </div>
        </div>

        <form id="createRuanganForm" action="{{ route('ruangan.store') }}" method="POST" onsubmit="event.preventDefault(); showConfirmModal();">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Contoh: Lab Komputer 2, Ruang X RPL 1" 
                    ...
                    @foreach($jenisOptions as $option)
                        <label class="jenis-option">
                            <input type="radio" 
                                   name="jenis_ruangan" 
                                   value="{{ $option }}" 
                                   {{ old('jenis_ruangan', 'Kelas Biasa') == $option ? 'checked' : '' }}>
...
<div class="modal-bg" id="confirmModal">
    <div class="modal-card">
        <div class="modal-icon-wrap">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
        </div>
        <h3>Konfirmasi Tambah Ruangan</h3>
        <p>Apakah Anda yakin ingin menambahkan data ruangan baru ini ke database?</p>
        ...
        <div class="modal-actions">
            ...
            <button type="button" class="btn-modal-confirm" onclick="submitForm()">Ya, Simpan Data</button>
        </div>
    </div>
</div>
...
<script>
    function showConfirmModal() {
        ...
        const jenisVal = jenisRadio ? jenisRadio.value : 'Kelas Biasa';
    ...
    function submitForm() {
        document.getElementById('createRuanganForm').submit();
    }
