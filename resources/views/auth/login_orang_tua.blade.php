...
<div class="login-wrapper">
    ...
    <div class="card-section">
        <div class="login-card">
            ...
            <div class="announcement-box">
                ...
                <div class="announcement-body">
                    <div class="announcement-title">Petunjuk Akses Orang Tua</div>
                    <div class="announcement-text">
                        Gunakan <strong>NISN dari putra/putri Anda</strong> dan password akun Orang Tua yang telah dibuat oleh pihak <strong>Administrator Tata Usaha (TU)</strong> sekolah.
                    </div>
                </div>
            </div>
        ...
        <div class="security-footer">
            ...
            <span>Sistem aman &amp; terproteksi. Data presensi terhubung akurat.</span>
        </div>
    </div>
