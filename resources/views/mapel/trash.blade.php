...
@section('title', 'Tempat Sampah Mapel — Jurnal ESEMKITA')
        ...
        <div class="table-responsive">
            <table class="table-custom">
                ...
                <tbody>
                    @forelse($mapels as $m)
                        <tr>
                            <td><span style="font-family:monospace; color:#3b5490; font-weight:700;">{{ $m->kode_mapel }}</span></td>
                            <td><strong>{{ $m->nama_mapel }}</strong></td>
                            <td>{{ $m->deleted_at ? \Carbon\Carbon::parse($m->deleted_at)->format('d/m/Y H:i') : '-' }}</td>
