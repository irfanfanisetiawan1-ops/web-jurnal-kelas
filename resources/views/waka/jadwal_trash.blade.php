...
@section('title', 'Kotak Sampah Jadwal Pelajaran — Waka Portal')
    ...
    <div class="page-header-box">
        <div>
            <div style="font-size: 12px; font-weight: 700; color: #64748b; margin-bottom: 4px;">
                <a href="{{ route('waka.jadwal') }}" style="color: #64748b; text-decoration: none;">&larr; Kembali ke Jadwal Pelajaran</a>
            </div>
