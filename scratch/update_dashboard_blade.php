...
$dashboardBlade = <<<'BLADE'
@extends('layouts.kepala_sekolah')

@section('title', 'Dashboard — Jurnal SMEA')
...
file_put_contents('c:/laragon/www/web-jurnal-kelas/resources/views/kepala_sekolah/dashboard.blade.php', $dashboardBlade);
echo "Updated kepala_sekolah/dashboard.blade.php successfully!\n";
